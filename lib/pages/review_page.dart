...
class _ReviewPageState extends State<ReviewPage> {
  ...
  String posString(state) {
    ...
    return _oldRoute != null && _oldRoute.length > 0
        ? Position(
                ...
                longitude:
                    _oldRoute[_oldRoute.length - 1].longitude.toPrecision(6))
            .toString()
        ...
        ? Container(
            ...
            child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  print(
                      'list with items in review drop down ${state.savedPaths[index]} ');
                  return GestureDetector(
                    onTap: () => setState(() {
                      ...
                      geolocationBloc.add(GeoEvent.showSaved);
                      geolocationBloc.add(GeoEvent.moveCam);
                    }),
                    child: Padding(
                      padding: index == 0
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<GeolocationBloc, GeoState>(builder: (context, state) {
      ...
      print('review page route name? ${state.routeName} and $_selectedRouteName ');
      if (_selectedRouteName == null &&
          state.status == Status.showSaved &&
...
//edit form field
            _openEdit //show track edit & delete field
                ? Positioned(
                    ...
                    child: Container(
                      padding:
                          EdgeInsets.only(left: 8, right: 3, top: 0, bottom: 0),
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(50),
                        color: Theme.of(context).buttonColor,
                      ),
                        ...
                        children: <Widget>[
                              ...
                              child: TextFormField(
                                validator: (value) {
                                  if (value.isEmpty || value == null)
                                    return 'saving date'; // 'saving to current route file';
                                  else
                                    return null;
                                },
                                ...
                                onFieldSubmitted: (value) {
                                  ...
                                  geolocationBloc
                                      .setNewRouteName(_selectedRouteName);
                          ...
                          Column(
                            children: <Widget>[
                              Material(
                                ...
                                child: InkWell(
                                  onTap: () {
                                    ...
                                    if (_fileName != null) {   //only save if filename was changed
                              ...
                              Material(
                                // close edit track x with circle
                                borderRadius: BorderRadius.circular(50),
                                color: Colors.transparent,
                                child: InkWell(
                                  onTap: () {
